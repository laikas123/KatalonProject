...
WebUI.waitForPageLoad(8, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Page_ScreenPal (Formerly Screencast-O-Matic_a228d3/a_Log In'), FailureHandling.STOP_ON_FAILURE)
